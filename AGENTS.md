...
- Treat `doc/system_requirements.md`, `doc/design.md`, referenced `doc/design/` chapters, `doc/design/quality_requirements.md`, and `doc/changesets/` as the source of truth for changes that affect requirements, design, behavior, tests, or verification.
...
- Keep OpenFastTrace IDs stable unless semantics change, and keep traceability clean between requirements, scenarios, design items, implementation, and tests.
